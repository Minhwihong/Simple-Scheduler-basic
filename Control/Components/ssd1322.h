...
// Use PORTA pin 4 as chip select pin

#define CHIP_SELECT_HIGH()                      GPIOA->BSRR = GPIO_BSRR_BS_15
#define CHIP_SELECT_LOW()                       GPIOA->BSRR = GPIO_BSRR_BR_15
// Use PORTD pin 8 as data / command pin

#define DATA_COMMAND_HIGH()                     GPIOA->BSRR = GPIO_BSRR_BS_7
#define DATA_COMMAND_LOW()                      GPIOA->BSRR = GPIO_BSRR_BR_7
// Use PORTB pin 8 as chip reset pin
#define CHIP_RESET_HIGH()                       GPIOC->BSRR = GPIO_BSRR_BS_4
#define CHIP_RESET_LOW()                        GPIOC->BSRR = GPIO_BSRR_BR_4
